...
def run():
    ...
    modelSentencizer = spacy.load("de_core_news_lg", disable=['ner'])
    ...
    for group in groups[2:]: 
        ...
        for docid in group['docids']: 
            ...
            doc_sents = modelSentencizer(text)
            ...
            for sent in doc_sents.sents: 
                ...
                doc = modelRT.nlp(sent.text)

                for cat in doc.cats: 
                    prediction[cat] = max(prediction[cat], doc.cats[cat])
